...
function Services() {
  return (
    <div className="service-container">
      ...
      />
      <p>
        Since 1992 – 30 Years of Experience… <br />
        <br />
        We, feel also both pleased & honored to introduce ourselves as Trippy
        Travel DMC (Destination Management Company) is one of the leading travel
        company in Istanbul, Turkey Operated by a team of professionals with a
        ...
        Tourism board, who are intimately familiar & sensitive to nature,
        culture & people of places, we visit.
        <br />
        Our mission statement would be to provide quality service, practical
        advice and flexible products that meets the need of our guests. It would
        be appreciated if you could allowus the opportunity to entertain you
        scenic splendor magical cultural experiences & variety entertainment
        activities that will make you have the perfect vacation in any
        destination.
        <br />
        Please do not hesitate to contact us with your thoughts & comments in
        order to go one step ahead to generate our mission .We look forward to
        welcoming you to the country where the continents meet….
        <br />
        Thanks and Best Regards.
        <br />
        Mr. Emre Ates – President
      </p>
    </div>
  );
}
